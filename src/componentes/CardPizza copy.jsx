...
const CardPizza = ({ nombre, precio, stock, disponibilidad, img, ingredientes }) => {
  ...
  const { cart, setCart, total, sumaPizza, restaPizza, pizzas } = useContext(MyContext);
        ...
        <div className="card ">
          ...
          <div className="card-body">
            ...
            <div className="container d-flex justify-content-around pt-3">
              ...
              <button onClick={() => sumaPizza(pizza.id)} type="button" className="btn btn-dark">Añadir 🛒</button>
            </div>
          </div>
        </div>
      </article>
